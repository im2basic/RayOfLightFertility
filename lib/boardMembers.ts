...
export const boardMembers: BoardMember[] = [
  ...
  },
  {
    ...
    role: "Board Director / Co-Director, The ART of Infertility",
    photo: "/assets/board/maria-novotny.jpg",
    bio: "Maria Novotny (she/her) is an Associate Professor of English at the University of Wisconsin-Milwaukee in the Rhetoric, Professional Writing, and Community Engagement program. Drawing on a reproductive justice framework, she writes about reproductive advocacy, in particular infertility and recurrent reproductive loss. Her co-edited collection Infertilities, A Curation (Wayne State University Press, 2023) portrays the ranging experiences of infertility in art and writing.\n\nThis collection is directly tied to her work as the Co-Director for The ART of Infertility, which is an arts-based infertility storytelling project. In 2018, the organization was recognized by RESOLVE: The National Infertility Association for its innovative approach to infertility advocacy via the arts and storytelling.\n\nAs a volunteer, Maria works closely with the Building Families Alliance of WI, which is a coalition of Wisconsinites advocating for fertility-friendly state legislation and reducing inequities to family building.\n\nBe sure to check out her new exhibit, In a State of IF, at MIAD in the Layton Gallery from August 17 to November 21, 2026. Maria is also a proud adoptive mom of a 7-year-old girl whom she adopted with her husband in Stevens Point, WI.",
  },
];
